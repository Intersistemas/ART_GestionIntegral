...
type EditState = {
  action?: EditAction,
  data?: Partial<EstablecimientoDeclaradoDTO>,
  disabled?: Partial<Record<keyof EstablecimientoDeclaradoDTO, boolean>>,
  errors?: Partial<Record<keyof EstablecimientoDeclaradoDTO, boolean>>,
  helpers?: Partial<Record<keyof EstablecimientoDeclaradoDTO, ReactNode>>,
  message?: string;
};
export default function EstablecimientoDeclaradoHandler() {
  ...
  function handleOnChange(changes: Partial<EstablecimientoDeclaradoDTO>) {
