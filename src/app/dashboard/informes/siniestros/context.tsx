...
// Opciones conocidas (idéntico estilo al CCMM original)
...
export function CCMMContextProvider({ children }: { children: ReactNode }) {
  const [tables] = useState<Tables>({
    vSiniestrosWeb230925: [
      ...
      { name: "EstablecimientoProvincia", label: "Prov. Establecimiento" },
      { name: "EstablecimientoProvinciaDesc", label: "Prov. Establecimiento (Desc.)" },
      { name: "EstablecimientoLocalidad", label: "Loc. Establecimiento" },
      { name: "EstablecimientoLocalidadDescripcion", label: "Loc. Establecimiento (Desc.)" },

      { name: "ProvinciaOcurrencia", label: "Prov. Ocurrencia" },
      { name: "LocalidadOcurrencia", label: "Loc. Ocurrencia" },
      ...
      { name: "FechaNAC", label: "Fecha Nac.", type: "date", formatter: fechaFormatter },
      ...
      { name: "Diagnostico1", label: "Diagnóstico 1" },
      { name: "Diagnostico2", label: "Diagnóstico 2" },
      { name: "Diagnostico3", label: "Diagnóstico 3" },
      ...
      { name: "PrestadorActual", label: "Prestador Actual" },
